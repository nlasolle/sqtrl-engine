...
class TransformationProcessTest {
	...
	void testRuleApplyer(String queryFile) throws IOException, QueryException {
		...
		List<RuleApplication> applications = applyer.getRuleApplications(query, rule, SPARQL_ENDPOINT);
